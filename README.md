...
7. Собирает стату по аккаунтам в сети скролл, кол-во транз, кол-во уникальных контрактов(пока работает не очень), активность по месяцам/неделям/дням и наличие НФТ за деплой контракта
