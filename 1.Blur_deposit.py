...
#Скрипт отправляет рандомные суммы ETH в заданных пределах, поочередно с рандомно заданной задержкой, на контракт Blur, активируя функцию Deposit. 
...
# Информация для подключения к Ethereum через RPC и контракт
